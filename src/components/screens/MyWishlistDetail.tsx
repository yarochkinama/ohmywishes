      ...
      <div className="scroll-y flex-1">
        ...
        <div style={{ padding: '14px 20px', borderBottom: '1px solid #F0F0F0' }}>
          ...
          <div style={{ display: 'flex', gap: 8, marginTop: 12 }}>
            <button
              onClick={onShare}
              className="press"
              style={{ padding: '7px 16px', borderRadius: 100, border: '1px solid #6BA83A', background: 'white', color: '#6BA83A', fontSize: 13, fontWeight: 500, cursor: 'pointer' }}
            >
              Поделиться
            </button>
            <button
        ...
        <div style={{ padding: '14px 20px', borderBottom: '1px solid #F0F0F0' }}>
          <button
            onClick={onAdd}
            className="press"
            style={{ width: '100%', height: 54, borderRadius: 14, background: '#6BA83A', color: 'white', fontWeight: 600, fontSize: 16, border: 'none', cursor: 'pointer' }}
          >
            + Добавить подарок
          </button>
        </div>
