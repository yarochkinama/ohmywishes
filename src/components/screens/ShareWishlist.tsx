  ...
  return (
    <div className="absolute inset-0 flex flex-col bg-white">
      ...
      <div className="scroll-y flex-1" style={{ padding: '8px 20px 32px' }}>
        ...
        <div style={{ marginBottom: 24 }}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 10, padding: '12px 14px', borderRadius: 12, background: '#F5F5F5' }}>
            ...
            <button className="press" style={{ background: 'none', border: 'none', cursor: 'pointer', padding: 4 }}>
              <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#6BA83A" strokeWidth="2"><rect x="9" y="9" width="13" height="13" rx="2"/><path d="M5 15H4a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2h9a2 2 0 0 1 2 2v1"/></svg>
            </button>
          </div>
        </div>
        ...
        <button
          className="press"
          style={{ width: '100%', height: 54, borderRadius: 14, background: '#6BA83A', color: 'white', fontWeight: 600, fontSize: 16, border: 'none', cursor: 'pointer', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 10 }}
        >
