  ...
  return (
    <div className="absolute inset-0 flex flex-col bg-white">
      ...
      <div className="scroll-y flex-1" style={{ padding: '8px 20px 32px' }}>
        ...
        <button
          className="press"
          style={{ width: '100%', height: 54, borderRadius: 14, background: '#D9FA85', color: '#111111', fontWeight: 600, fontSize: 16, border: 'none', cursor: 'pointer', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 10 }}
        >
